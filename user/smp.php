...
<div class="container">
<h2>Data Buku SMP</h2><br>
<div class="col-xs-8">
	<div class="input-group">
		<input name="key" class="form-control" placeholder="Cari Buku SMP" type="text" value="">
...
<h2>Kelas 7</h2><br>
<a class="btn btn-success" href="tambah7.php"><i class="fa fa-plus"></i> +TAMBAH BUKU</a>
    <br/>
    <br/>
    <table class="table table-bordered table-striped dataTable" border="1">
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-xs btn-flat" href="edit7.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">EDIT</a>
                    <a class="btn btn-primary btn-xs btn-flat" href="hapus7.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">HAPUS</a>
                </td>
            </tr>
            <?php 
        }
    ...
    <h2>Kelas 8</h2><br>
    <a class="btn btn-success" href="tambah8.php"><i class="fa fa-plus"></i> +TAMBAH BUKU</a>
    <br/>
    <br/>
    <table class="table table-bordered table-striped dataTable" border="1">
        <tr>
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td><?php echo $d['jumlah']; ?></td>
                <td>
                    <a class="btn btn-primary btn-xs btn-flat" href="edit8.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">EDIT</a>
                    <a class="btn btn-primary btn-xs btn-flat" href="hapus8.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">HAPUS</a>
                </td>
            </tr>
            <?php 
        }
    ...
    <h2>Kelas 9</h2><br>
    <a class="btn btn-success" href="tambah9.php"><i class="fa fa-plus"></i> +TAMBAH BUKU</a>
    <br/>
    <br/>
    <table class="table table-bordered table-striped dataTable" border="1">
        <tr>
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td><?php echo $d['jumlah']; ?></td>
                <td>
                    <a class="btn btn-primary btn-xs btn-flat" href="edit9.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">EDIT</a>
                    <a class="btn btn-primary btn-xs btn-flat" href="hapus9.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">HAPUS</a>
                </td>
            </tr>
            <?php 
        }
