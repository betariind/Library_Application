...
<html lang="en">
  <head>
    ...
    <title>Edit Data Buku Umum</title>
    <style type="text/css">
        body{
            background: #f8f6f5;
        }
...
<div class="container">
<h3>Edit Data Buku Non Ilmiah</h3><br>
<a class="btn btn-warning" href="umum.php"><i class="fa fa-plus"></i> Kembali</a>
<br>
<br>
<?php
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from tbnonilmiah where id='$id'");
while($d = mysqli_fetch_array($data)){
    ?>
    <form method="post" action="edit_act13.php">
        <table>
            <tr>            
                <td>Kode Buku</td>
                <td>
