...
<li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="tambah14.php">Tetap di aplikasi</a></li>
    </ul>
</ul>
</div><br>
<div class="container">
<h3>Tambah Data Peminjaman</h3><br>
<a class="btn btn-warning" href="pinjam.php"><i class="fa fa-plus"></i> Kembali</a>
<br>
<br>
    <form method="post" action="tambah_act14.php">
        <table>
            <tr>            
                <td>No Pinjam</td>
            ...
            <tr>
                ...
                <td><input type="text" name="tgl_hrs_kembali"></td>
            </tr>
            <tr>
                <td>Status</td>
