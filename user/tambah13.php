...
<html lang="en">
  <head>
    ...
    <title>Tambah Data Buku Non Ilmiah</title>
    <style type="text/css">
        body{
            background: #f8f6f5;
        }
...
<li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="tambah13.php">Tetap di aplikasi</a></li>
    </ul>
</ul>
</div><br>
<div class="container">
<h3>Tambah Data Buku Non Ilmiah</h3><br>
<a class="btn btn-warning" href="umum.php"><i class="fa fa-plus"></i> Kembali</a>
<br>
<br>
    <form method="post" action="tambah_act13.php">
        <table>
            <tr>            
                <td>Kode Buku</td>
