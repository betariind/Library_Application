...
<li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="pinjam.php">Tetap di aplikasi</a></li>
    </ul>
</ul>
</div><br>
<div class="container">
  
<h2>Data Pinjam Buku</h2><br>
<div class="col-xs-8">
	<div class="input-group">
	  <input name="key" class="form-control" placeholder="Cari Data Peminjam Buku" type="text" value="">
...
<a class="btn btn-success" href="tambah14.php"><i class="fa fa-plus"></i> +TAMBAH TRANSAKSI</a>
    <br/>
    <br/>
    <table class="table table-bordered table-striped dataTable" border="1">
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td>
                <a class="btn btn-primary btn-xs btn-flat" href="hapus14.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">HAPUS</a>
                </td>
            </tr>
            <?php 
        }
