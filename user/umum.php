...
<li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="umum.php">Tetap di aplikasi</a></li>
    </ul>
</ul>
</div><br>
<div class="container">
  <h2>Data Buku Umum</h2><br>
  <div class="col-xs-8">
		<div class="input-group">
			<input name="key" class="form-control" placeholder="Cari Data Buku" type="text" value="">
...
<h2>Ilmiah</h2><br>
<a class="btn btn-success" href="tambah12.php"><i class="fa fa-plus"></i> +TAMBAH BUKU</a>
    <br/>
    <br/>
    <table class="table table-bordered table-striped dataTable" border="1">
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-xs btn-flat" href="edit12.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">EDIT</a>
                    <a class="btn btn-primary btn-xs btn-flat" href="hapus12.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">HAPUS</a>
                </td>
            </tr>
            <?php 
        }
    ...
    <h2>Non Ilmiah</h2><br>
    <a class="btn btn-success" href="tambah13.php"><i class="fa fa-plus"></i> +TAMBAH BUKU</a>
    <br/>
    <br/>
    <table class="table table-bordered table-striped dataTable" border="1">
        <tr>
        ...
        while($d = mysqli_fetch_array($data)){
            ...
            <tr>
                ...
                <td><?php echo $d['jumlah']; ?></td>
                <td>
                    <a class="btn btn-primary btn-xs btn-flat" href="edit13.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">EDIT</a>
                    <a class="btn btn-primary btn-xs btn-flat" href="hapus13.php?id=<?php echo $d['id']; ?>" data-type="edit" data-toogle="tooltip">HAPUS</a>
                </td>
            </tr>
            <?php 
        }
