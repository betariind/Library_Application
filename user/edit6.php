...
<div class="container">
<h3>Edit Data Buku SD kelas 6</h3><br>
...
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from tbsd6 where id='$id'");
while($d = mysqli_fetch_array($data)){
    ?>
    <form method="post" action="edit_act6.php">
        <table>
            <tr>            
                <td>Kode Buku</td>
                <td>
