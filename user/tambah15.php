...
<li class="nav-item dropdown">
  ...
  <li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="tambah15.php">Tetap di aplikasi</a></li>
    </ul>
</ul>
</div><br>
<div class="container">
<h3>Tambah Data Pengembalian</h3><br>
<a class="btn btn-warning" href="kembali.php"><i class="fa fa-plus"></i> Kembali</a>
<br>
<br>
    <form method="post" action="tambah_act15.php">
        <table>
            <tr>            
                <td>No Pinjam</td>
