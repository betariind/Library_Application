...
<html lang="en">
  <head>
    ...
    <title>Edit Data Buku SMA</title>
    <style type="text/css">
        body{
            background: #f8f6f5;
        }
...
<li class="nav-item dropdown">
    ...
    <ul class="dropdown-menu">
      ...
      <li><a class="dropdown-item" href="index.php">Data Pegawai</a></li>
...
<div class="container">
<h3>Edit Data Buku SMA IPS</h3><br>
<a class="btn btn-warning" href="sma.php"><i class="fa fa-plus"></i> Kembali</a>
<br>
<br>
<?php
include 'koneksi.php';
$id = $_GET['id'];
$data = mysqli_query($koneksi,"select * from tbsmaips where id='$id'");
while($d = mysqli_fetch_array($data)){
    ?>
    <form method="post" action="edit_act11.php">
        <table>
            <tr>            
                <td>Kode Buku</td>
                <td>
